  ...
  return (
    <>
      <Image
        ...
        width={594}
        height={965}
        className="absolute left-1/2 top-0 h-[822px] w-[354px] -translate-x-1/2"
      />
      <main className="flex flex-col items-center">
        ...
        <Link
          href={PATH.MENU}
          className="relative z-10 mb-[173px] mt-[78px] rounded-[40px] bg-[#333333] px-[65px] py-[13px] text-[2.813rem] font-bold leading-[3.375rem] text-white"
        >
          GO!
        </Link>
      </main>
